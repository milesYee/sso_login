package com.miles.config.shiro;
...
public class ShiroConfig {
    ...
    // cas server地址
    public static final String casServerUrlPrefix = "http://192.168.0.107:9092/cas";
    // Cas登录页面地址
    public static final String casLoginUrl = casServerUrlPrefix + "/login";
    // Cas登出页面地址
    public static final String casLogoutUrl = casServerUrlPrefix + "/logout";
    // 当前工程对外提供的服务地址
    public static final String shiroServerUrlPrefix = "http://192.168.0.107:8085";
    ...
    public SecurityManager securityManager() {
        ...
        defaultSecurityManager.setRealm(myShiroCasRealm());
    ...
    public MyShiroCasRealm myShiroCasRealm() {
        ...
        //myShiroCasRealm.setCacheManager(cacheManager());
        //userShiroCasRealm.setCredentialsMatcher(hashedCredentialsMatcher());
        myShiroCasRealm.setCachingEnabled(false);
        myShiroCasRealm.setCasServerUrlPrefix(ShiroConfig.casServerUrlPrefix);
        myShiroCasRealm.setCasService(ShiroConfig.shiroServerUrlPrefix + ShiroConfig.casFilterUrlPattern);
